...
class Div2K(FolderByDir):
    ...
    track_dirs = {
      ...
      , ('hr', 'traonly', 1) : os.path.join('DIV2K_traonly_HR')
      , ('hr', 'traval', 1) : os.path.join('DIV2K_traval_HR')
      , ('hr', 'traval1a', 1) : os.path.join('DIV2K_traval1a_HR')
      , ('hr', 'traval1b', 1) : os.path.join('DIV2K_traval1b_HR')
      , ('hr', 'traval1c', 1) : os.path.join('DIV2K_traval1c_HR')
      , ('hr', 'traval5', 1) : os.path.join('DIV2K_traval5_HR')
      , ('hr', 'traval10', 1) : os.path.join('DIV2K_traval10_HR')
      , ('hr', 'traval50', 1) : os.path.join('DIV2K_traval50_HR')
      ...
      , ('bicubic', 'traonly', 2) : os.path.join('DIV2K_traonly_LR_bicubic', 'X2')
      , ('bicubic', 'traonly', 3) : os.path.join('DIV2K_traonly_LR_bicubic', 'X3')
      , ('bicubic', 'traonly', 4) : os.path.join('DIV2K_traonly_LR_bicubic', 'X4')
      , ('bicubic', 'traval', 2) : os.path.join('DIV2K_traval_LR_bicubic', 'X2')
      , ('bicubic', 'traval1a', 2) : os.path.join('DIV2K_traval1a_LR_bicubic', 'X2')
      , ('bicubic', 'traval1b', 2) : os.path.join('DIV2K_traval1b_LR_bicubic', 'X2')
      , ('bicubic', 'traval1c', 2) : os.path.join('DIV2K_traval1c_LR_bicubic', 'X2')
      , ('bicubic', 'traval5', 2) : os.path.join('DIV2K_traval5_LR_bicubic', 'X2')
      , ('bicubic', 'traval10', 2) : os.path.join('DIV2K_traval10_LR_bicubic', 'X2')
      , ('bicubic', 'traval50', 2) : os.path.join('DIV2K_traval50_LR_bicubic', 'X2')
      , ('bicubic', 'traval', 3) : os.path.join('DIV2K_traval_LR_bicubic', 'X3')
      , ('bicubic', 'traval', 4) : os.path.join('DIV2K_traval_LR_bicubic', 'X4')
