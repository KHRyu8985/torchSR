...
model.add_argument('--log', type=str,
                   help='save log_file')
model.add_argument('--seed', type=int, default=729,
                   help='random seed')
...
run.add_argument('--hr', type=str, nargs="+",
                 help='run on the given images')
...
train.add_argument('--lr', type=float, default=1e-4,
                   help='learning rate')
train.add_argument('--lre', type=bool, default=False,
                   help='learning reweight')
train.add_argument('--index-patch', type=bool, default=False,
                   help='learning reweight')
train.add_argument('--batch-reweight', type='bool', default=False,
                   help='learning reweight')
train.add_argument('--reweight', type=int, default=2,
                   help='learning reweight')
train.add_argument('--metric', type=int, default=0,
                   help='learning reweight')
train.add_argument('--imagename', type=str, 
                   help='learning reweight')

train.add_argument('--noise', type=str,
                   help='noise aug')
train.add_argument('--noise-value', type=int, default=0,
                   help='shift aug')
# train.add_argument('--shift', type=int, default=1,
#                    help='shift aug')
# train.add_argument('--rotate', type=int, default=1,
#                    help='rotate aug')
# train.add_argument('--distort', type=int, default=1,
#                    help='distort aug')
...
train.add_argument('--save-every', type=int, default=150, help='keep every nth checkpoints')
...
data.add_argument('--dataset-train', nargs='+', default=[DatasetType.Div2KBicubic],
                  type=DatasetType, choices=[DatasetType.Div2KBicubic, DatasetType.Div2KUnknown, DatasetType.AlignFormer, DatasetType.Zoom], 
                  help='Training dataset')
data.add_argument('--dataset-traval', nargs='+', default=[DatasetType.Div2KBicubic],
                  type=DatasetType, choices=list(DatasetType),
                  help='Training dataset')
data.add_argument('--dataset-val', nargs='+', default=[DatasetType.Div2KBicubic],
                  type=DatasetType, choices=list(DatasetType),
                  help='Validation dataset')
data.add_argument('--dataset-test', nargs='+', default=[DatasetType.Div2KBicubic],
                  type=DatasetType, choices=list(DatasetType),
                  help='Test dataset')
...
data.add_argument('--patch-size-traval', type=int, default=96,
                  help='image patch size for traval (HR)')
