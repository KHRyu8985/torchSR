...
do   
    ...
    do
        ...
        BS=256
        LR=1e-3
        CHECK_FILE=2x_bs${BS}_300epochs_l1_div2k_bicubic_${NOSIE}${ROTATE}_lre_higher_${var}
        WORK_FILE=2x_bs${BS}_300epochs_l1_div2k_bicubic_${NOISE}${ROTATE}_batch_lre_higher_${TODAY}_${var}
